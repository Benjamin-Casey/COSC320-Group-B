...
namespace CollegeQ\TWM\Endpoint;
use CollegeQ\TWM;
...
class Example {
	...
	private function __construct() {
        $plugin = TWM\Plugin::get_instance();
    ...
    public function get_example( $request ) {
        $example_option = get_option( 'TWM_example_setting' );
    ...
    public function update_example( $request ) {
        $updated = update_option( 'TWM_example_setting', $request->get_param( 'exampleSetting' ) );
    ...
    public function delete_example( $request ) {
        $deleted = delete_option( 'TWM_example_setting' );
